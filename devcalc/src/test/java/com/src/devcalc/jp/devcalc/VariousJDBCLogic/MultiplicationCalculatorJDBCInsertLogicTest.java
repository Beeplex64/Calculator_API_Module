...
public class MultiplicationCalculatorJDBCInsertLogicTest {
	...
	@InjectMocks
	MultiplicationCalculatorJDBCInsertLogic target = new MultiplicationCalculatorJDBCInsertLogic();
	...
	public void testService_OK() throws SQLException, ClassNotFoundException {
		...
		Response response = target.F_MultiplicationJDBCService(userId, number1, number2, symbol, result);
		...
		assertEquals(additionResponseDetails.getApino(), "2.MultiplicationCalcAPI");
	}
