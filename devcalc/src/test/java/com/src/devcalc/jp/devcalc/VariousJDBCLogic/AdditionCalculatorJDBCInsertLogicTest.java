...
public class AdditionCalculatorJDBCInsertLogicTest {
	...
	@InjectMocks
	AdditionCalculatorJDBCInsertLogic target = new AdditionCalculatorJDBCInsertLogic();
	...
	public void testService_OK() throws SQLException, ClassNotFoundException {
		...
		Response response = target.F_AdditionJDBCService(userId, number1, number2, symbol, result);
