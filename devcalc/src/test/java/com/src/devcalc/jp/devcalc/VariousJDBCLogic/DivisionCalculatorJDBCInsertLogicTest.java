...
public class DivisionCalculatorJDBCInsertLogicTest {
	...
	@InjectMocks
	DivisionCalculatorJDBCInsertLogic target = new DivisionCalculatorJDBCInsertLogic();
	...
	public void testService_OK() throws SQLException, ClassNotFoundException {
		...
		Response response = target.F_DivisionJDBCService(userId, number1, number2, symbol, result);
		...
		assertEquals(additionResponseDetails.getApino(), "4.DivisionCalcAPI");
	}
