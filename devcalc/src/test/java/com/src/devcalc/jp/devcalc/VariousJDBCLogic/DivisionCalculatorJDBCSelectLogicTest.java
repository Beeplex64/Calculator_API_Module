...
public class DivisionCalculatorJDBCSelectLogicTest {
	...
	@InjectMocks
	DivisionCalculatorJDBCSelectLogic target = new DivisionCalculatorJDBCSelectLogic();
	...
	public void testService_OK() throws SQLException, ClassNotFoundException {
		...
		Response response = target.F_DivisionService(userId);
