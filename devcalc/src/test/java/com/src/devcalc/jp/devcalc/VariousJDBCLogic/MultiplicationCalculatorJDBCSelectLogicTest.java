...
public class MultiplicationCalculatorJDBCSelectLogicTest {
	...
	@InjectMocks
	MultiplicationCalculatorJDBCSelectLogic target = new MultiplicationCalculatorJDBCSelectLogic();
	...
	public void testService_OK() throws SQLException, ClassNotFoundException {
		...
		Response response = target.F_MultiplicationService(userId);
